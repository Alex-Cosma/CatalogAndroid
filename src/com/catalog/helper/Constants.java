...
public class Constants {
	...
	public static final String StatisticsActivity = "StatisticsActivity";
	 ...
	 * Charts
	 */
	public static String[] CHARTS_NAMES = { "Graficul Mediilor la Gimnaziu",
			"Raport Absente / Medii Gimnaziu",
			"Graficul Mediilor la clasele IX-X",
			"Graficul Mediilor la clasele XI-XII",
			"Raport Absente / Medii Liceu",
			"Rapoarte materie / absente generale" };
}
